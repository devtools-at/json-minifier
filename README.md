...
<p align="center">
  <a href="https://devtools.at/tools/json-minifier"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Minify JSON by removing whitespace</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/json-minifier">Try Online</a> •
...
**[Try JSON Minifier online at DevTools.at →](https://devtools.at/tools/json-minifier)**
...
Minify JSON by removing whitespace. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/json-minifier';
